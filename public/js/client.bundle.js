...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatMessage = _react2.default.createClass({
	    ...
	    render: function render() {
	        ...
	        return _react2.default.createElement(
	            'div',
	            { className: bodyClass },
	            _react2.default.createElement('span', { className: 'avatar', style: styles }),
	...
	var ChatMessageList = _react2.default.createClass({
	...
	var ChatForm = _react2.default.createClass({
	    ...
	    handleTextKeyDown: function handleTextKeyDown(e) {
	        if (e.keyCode === 13) {
	            if (!e.shiftKey) {
	                this.handleSubmit(e);
	            }
	...
	var ChatConfiguration = _react2.default.createClass({
	    displayName: 'ChatConfiguration',
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'chat-configuration' },
	            _react2.default.createElement(
	                'form',
	                { className: 'chat-configuration-form', onSubmit: this.handleSubmit },
	...
	var ChatBox = _react2.default.createClass({
	    ...
	    handleChatSubmit: function handleChatSubmit(msg) {
	    ...
	    render: function render() {
	        return _react2.default.createElement(
	            'div',
	            { className: 'chat' },
	            _react2.default.createElement(ChatConfiguration, null),
	            _react2.default.createElement(
	                'div',
	                { className: 'messages-container' },
	                _react2.default.createElement(ChatMessageList, { messages: this.state.messages }),
	                _react2.default.createElement(ChatForm, { handleChatSubmit: this.handleChatSubmit })
	            )
	        );
	    }
	});
	
	_reactDom2.default.render(_react2.default.createElement(ChatBox, null), document.getElementById('chat-container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  box-sizing: border-box; }\n\nbody {\n  align-items: center;\n  background-color: #565e60;\n  display: flex;\n  height: 100vh;\n  justify-content: center;\n  margin: 0;\n  padding: 0;\n  width: 100vw; }\n\n.container {\n  width: 90vw; }\n\n.chat {\n  background-color: white;\n  box-shadow: 0 2px 2px #bfff8e;\n  display: flex;\n  height: 90vh;\n  padding: 1vh;\n  padding-bottom: 0; }\n  .chat-configuration {\n    background-color: white;\n    width: 20%; }\n    .chat-configuration-form {\n      padding-right: 1vw; }\n      .chat-configuration-form-email {\n        border: 1px solid #565e60;\n        font-size: 12px;\n        height: 30px;\n        margin: 10px 0;\n        padding: 0 10px;\n        width: 100%; }\n        .chat-configuration-form-email:focus {\n          outline: none; }\n      .chat-configuration-form input {\n        margin-bottom: 10px;\n        height: 40px;\n        padding: 5px;\n        width: 100%; }\n      .chat-configuration-form button {\n        background: white;\n        border: 1px solid #dbdbdb;\n        color: #565e60;\n        cursor: pointer;\n        font-size: 13px;\n        padding: 5px 10px; }\n  .chat .messages-container {\n    border-left: 1px solid #dbdbdb;\n    width: 80%; }\n    .chat .messages-container .list {\n      background: #565e60;\n      height: 84vh;\n      overflow-y: auto;\n      padding: 15px; }\n      .chat .messages-container .list .message {\n        align-items: center;\n        display: flex;\n        margin: 5px; }\n        .chat .messages-container .list .message:after {\n          clear: both;\n          content: ' ';\n          display: block;\n          height: 0;\n          visibility: hidden; }\n        .chat .messages-container .list .message .avatar {\n          background-size: cover;\n          border-radius: 20px;\n          box-shadow: 0 1px 2px #565e60;\n          display: block;\n          height: 30px;\n          margin: 0 5px;\n          width: 30px; }\n        .chat .messages-container .list .message .text {\n          border-radius: 0 5px 5px 10px;\n          box-shadow: 0 1px 2px #dbdbdb;\n          color: #565e60;\n          display: inline-block;\n          margin: 6px 0 0;\n          max-width: 190px;\n          padding: 5px 10px;\n          white-space: pre-line;\n          word-wrap: break-word; }\n        .chat .messages-container .list .message-myself {\n          justify-content: flex-end; }\n      .chat .messages-container .list .from-other .message-text {\n        background: #bfff8e; }\n      .chat .messages-container .list .from-other .message-avatar {\n        background-color: #bfff8e; }\n      .chat .messages-container .list .from-myself .message-text {\n        background: #dbdbdb; }\n      .chat .messages-container .list .from-myself .message-avatar {\n        background-color: #dbdbdb; }\n    .chat .messages-container .chat-form {\n      border-top: 2px solid #dbdbdb; }\n    .chat .messages-container .chat-input {\n      border: 0;\n      font-size: 15px;\n      height: 50px;\n      padding: 10px;\n      resize: none;\n      width: 100%; }\n      .chat .messages-container .chat-input:focus {\n        outline: none; }\n", "", {"version":3,"sources":["/./src/client/scss/main.scss","/./src/client/scss/_colors.scss","/./src/client/scss/_variables.scss"],"names":[],"mappings":"AAGA;EACE,uBAAuB,EACxB;;AAED;EACE,oBAAoB;EACpB,0BCDiB;EDEjB,cAAc;EACd,cAAc;EACd,wBAAwB;EACxB,UAAU;EACV,WAAW;EACX,aAAa,EACd;;AAED;EACE,YAAY,EACb;;AAED;EACE,wBCrBS;EDsBT,8BCNmB;EDOnB,cAAc;EACd,aAAa;EACb,aAAa;EACb,kBAAkB,EAuInB;EA7ID;IASI,wBC7BO;ID8BP,WAAW,EAkCZ;IA5CH;MAaM,mBAAmB,EA8BpB;MA3CL;QAgBQ,0BC9BW;QD+BX,gBAAgB;QAChB,aAAa;QACb,eAAe;QACf,gBAAgB;QAChB,YAAY,EAKb;QA1BP;UAwBU,cAAc,EACf;MAzBT;QA6BQ,oBAAoB;QACpB,aAAa;QACb,aAAa;QACb,YAAY,EACb;MAjCP;QAoCQ,kBCxDG;QDyDH,0BCpDW;QDqDX,eCpDW;QDqDX,gBAAgB;QAChB,gBAAgB;QAChB,kBAAkB,EACnB;EA1CP;IA+CI,+BC9De;ID+Df,WAAW,EA4FZ;IA5IH;MAmDM,oBCjEa;MDkEb,aAAa;MACb,iBAAiB;MACjB,cE5EgB,EFgJjB;MA1HL;QAyDQ,oBAAoB;QACpB,cAAc;QACd,YAAY,EAoCb;QA/FP;UA+DU,YAAY;UACZ,aAAa;UACb,eAAe;UACf,UAAU;UACV,mBAAmB,EACpB;QApET;UAuEU,uBAAuB;UACvB,oBAAoB;UACpB,8BCvFS;UDwFT,eAAe;UACf,aAAa;UACb,cAAc;UACd,YAAY,EACb;QA9ET;UAiFU,8BAA8B;UAC9B,8BCjGS;UDkGT,eCjGS;UDkGT,sBAAsB;UACtB,gBAAgB;UAChB,iBAAiB;UACjB,kBAAkB;UAClB,sBAAsB;UACtB,sBAAsB,EACvB;QA1FT;UA6FU,0BAA0B,EAC3B;MA9FT;QAqGc,oBCzGO,ED0GR;MAtGb;QAyGc,0BC7GO,ED8GR;MA1Gb;QAiHc,oBChIK,EDiIN;MAlHb;QAqHc,0BCpIK,EDqIN;IAtHb;MA6HM,8BC5Ia,ED6Id;IA9HL;MAiIM,UAAU;MACV,gBAAgB;MAChB,aAAa;MACb,cAAc;MACd,aAAa;MACb,YAAY,EAKb;MA3IL;QAyIQ,cAAc,EACf","file":"main.scss","sourcesContent":["@import './colors';\n@import './variables';\n\n* {\n  box-sizing: border-box;\n}\n\nbody {\n  align-items: center;\n  background-color: $gray-dark;\n  display: flex;\n  height: 100vh;\n  justify-content: center;\n  margin: 0;\n  padding: 0;\n  width: 100vw;\n}\n\n.container {\n  width: 90vw;\n}\n\n.chat {\n  background-color: $white;\n  box-shadow: 0 2px 2px $green-light;\n  display: flex;\n  height: 90vh;\n  padding: 1vh;\n  padding-bottom: 0;\n\n  &-configuration {\n    background-color: $white;\n    width: 20%;\n\n    &-form {\n      padding-right: 1vw;\n\n      &-email {\n        border: 1px solid $gray-dark;\n        font-size: 12px;\n        height: 30px;\n        margin: 10px 0;\n        padding: 0 10px;\n        width: 100%;\n\n        &:focus {\n          outline: none;\n        }\n      }\n\n      input {\n        margin-bottom: 10px;\n        height: 40px;\n        padding: 5px;\n        width: 100%;\n      }\n\n      button {\n        background: $white;\n        border: 1px solid $gray-light;\n        color: $gray-dark;\n        cursor: pointer;\n        font-size: 13px;\n        padding: 5px 10px;\n      }\n    }\n  }\n\n  .messages-container {\n    border-left: 1px solid $gray-light;\n    width: 80%;\n\n    .list {\n      background: $gray-dark;\n      height: 84vh;\n      overflow-y: auto;\n      padding: $default-padding;\n\n      .message {\n        align-items: center;\n        display: flex;\n        margin: 5px;\n\n        // clear fix this element\n        &:after {\n          clear: both;\n          content: ' ';\n          display: block;\n          height: 0;\n          visibility: hidden;\n        }\n\n        .avatar {\n          background-size: cover;\n          border-radius: 20px;\n          box-shadow: 0 1px 2px $gray-dark;\n          display: block;\n          height: 30px;\n          margin: 0 5px;\n          width: 30px;\n        }\n\n        .text {\n          border-radius: 0 5px 5px 10px;\n          box-shadow: 0 1px 2px $gray-light;\n          color: $gray-dark;\n          display: inline-block;\n          margin: 6px 0 0;\n          max-width: 190px;\n          padding: 5px 10px;\n          white-space: pre-line;\n          word-wrap: break-word;\n        }\n\n        &-myself {\n          justify-content: flex-end;\n        }\n      }\n\n      .from {\n        &-other {\n          .message {\n            &-text {\n              background: $green-light;\n            }\n\n            &-avatar {\n              background-color: $green-light;\n            }\n          }\n        }\n\n        &-myself {\n          .message {\n            &-text {\n              background: $gray-light;\n            }\n\n            &-avatar {\n              background-color: $gray-light;\n            }\n          }\n        }\n      }\n    }\n\n    .chat-form {\n      border-top: 2px solid $gray-light;\n    }\n\n    .chat-input {\n      border: 0;\n      font-size: 15px;\n      height: 50px;\n      padding: 10px;\n      resize: none;\n      width: 100%;\n\n      &:focus {\n        outline: none;\n      }\n    }\n  }\n}\n","////////////////////////////////////////////////////////////////////////////////\n// WHITE\n$white: rgb(255, 255, 255);\n\n\n////////////////////////////////////////////////////////////////////////////////\n// GRAY\n$gray-light:    rgb(219, 219, 219);\n$gray-dark:     rgb(86, 94, 96);\n\n\n////////////////////////////////////////////////////////////////////////////////\n// BLUE\n$light-blue:    rgb(91, 188, 250);\n\n\n////////////////////////////////////////////////////////////////////////////////\n// GREEN\n$green-light:     rgb(191, 255, 142);\n$green-darken:    rgb(32, 99, 12);\n","$default-padding: 15px;\n$default-margin:  10px;\n"],"sourceRoot":"webpack://"}]);
